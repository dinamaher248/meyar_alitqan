...
@Injectable(as: UpdateCustomerProfileRemoteDataSource)
class UpdateCustomerProfileRemoteDataSourceImpl
    implements UpdateCustomerProfileRemoteDataSource {
  ...
  Future<Either<Failures, void>> updateProfile({
    ...
    try {
      ...
      await apiManager.post(
        url: ApiEndPoints.updateCustomerProfile,
        token: accessToken,
