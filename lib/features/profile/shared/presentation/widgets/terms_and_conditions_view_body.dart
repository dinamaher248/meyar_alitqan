...
import 'package:meayar_alitqan/l10n/app_localizations_ar.dart';
import '../manager/get_terms_and_condiations_view_model/get_terms_and_condiations_view_model.dart';
import '../manager/get_terms_and_condiations_view_model/get_terms_and_condiations_view_model_states.dart';
...
class TermsAndConditionsViewBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<GetTermsAndCondiationsViewModel,
