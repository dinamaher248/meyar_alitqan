...
@injectable
 class GetRequestPriorityUseCase {
  final GetRequestPriorityRepo getRequestPriorityRepo;
  GetRequestPriorityUseCase(this.getRequestPriorityRepo);
  Future<Either<Failures, List<RequestPriorityEntity>>> call() async {
    return await getRequestPriorityRepo.getRequestPriority();
  }
}