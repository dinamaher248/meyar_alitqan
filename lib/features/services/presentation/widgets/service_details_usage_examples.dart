...
Widget buildElectricianServiceExample(BuildContext context) {
  ...
  reviews: const [
    ServiceReview(
      ...
      date: '12 يونيو 2026',
      reviewText: 'خدمة ممتازة وسريعة، الفني كان محترف وحل المشكلة في وقت قصير',
      starsCount: 4,
      avatarInitials: 'AM',
    ),
    ServiceReview(
...
Widget buildCleaningOfferExample(BuildContext context) {
  ...
  description: 'خدمة تنظيف متكاملة مقدمة من فريق صيانية متخصصين في نظافة البيوت',
  rating: 4.5,
  reviewsCount: 79,
